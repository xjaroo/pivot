(function () {
  ...
  callWithJQuery(function ($) {
    ...
    aggregatorTemplates = {
      ...
      p25_no_zeros: function (formatter) {
        if (formatter == null) formatter = usFmt;
        return aggregatorTemplates.quantile_no_zeros(0.25, formatter);
      },
      p50_no_zeros: function (formatter) {
        if (formatter == null) formatter = usFmt;
        return aggregatorTemplates.quantile_no_zeros(0.5, formatter);
      },
      p75_no_zeros: function (formatter) {
        if (formatter == null) formatter = usFmt;
        return aggregatorTemplates.quantile_no_zeros(0.75, formatter);
      },
      median_no_zeros: function (formatter) {
        return aggregatorTemplates.p50_no_zeros(formatter);
      },
      quantile_no_zeros: function (q, formatter) {
        if (formatter == null) formatter = usFmt;
        return function (arg) {
          var attr = arg[0];
          return function (data, rowKey, colKey) {
            return {
              ...
              push: function (record) {
                ...
                if (!isNaN(x) && x !== 0) this.vals.push(x);
              },
              value: function () {
                var i;
    ...
    aggregators = (function (tpl) {
      return {
        ...
        "p25 (no zeros)": tpl.p25_no_zeros(usFmt),
        "p50 (no zeros)": tpl.p50_no_zeros(usFmt),
        "p75 (no zeros)": tpl.p75_no_zeros(usFmt),
        "Median (no zeros)": tpl.median_no_zeros(usFmt),
      };
    })(aggregatorTemplates);
    renderers = {
    ...
    PivotData = (function () {
      ...
      PivotData.prototype.forEachMatchingRecord = function (
        criteria,
        callback
      ) {
      ...
      try {
        ...
        fn1 = function (attr) {
          var attrElem,
            ...
            values;
          values = [];
          for (v in attrValues[attr]) values.push(v);
    ...
    $.fn.heatmap = function (scope, opts) {
      ...
      colorScaleGenerator =
        opts != null
          ? (ref = opts.heatmap) != null
            ? ref.colorScaleGenerator
            : void 0
          : void 0;
